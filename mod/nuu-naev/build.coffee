...
module.exports.build = (c) ->
  depend(dirs)( ->
    $s [
      ...
      linkFilesIn 'contrib/naev-master/dat/gfx/spfx',            'build/gfx'
      linkFlatten 'contrib/naev-master/dat/gfx/ship',            'build/gfx'
      linkFilesIn 'contrib/naev-master/dat/gfx/bkg',             'build/gfx'
      linkFilesIn 'contrib/naev-master/dat/gfx/bkg/star',        'build/gfx'
      linkFilesIn 'contrib/naev-master/dat/gfx/planet/space',    'build/gfx'
      linkFilesIn 'contrib/naev-master/dat/gfx/outfit/space',    'build/gfx'
      link        'contrib/naev-master/dat/gfx/outfit/store',    'build/gfx/store'
