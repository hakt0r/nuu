...
rules.stars = [
  ...
  [ 31,  Station, 'UEG Agriculture-01',  'station-agriculture',   1000,        $orbit, 3, template:'LargeFarm']
  [ 32,  Station, 'UEG Battlestation-01','station-battlestation', 1000,        $orbit, 3, template:'Fortress']
  [ 33,  Station, 'UEG Commerce-01',     'station-commerce',      1000,        $orbit, 3, template:'Trade']
  [ 34,  Station, 'UEG Commerce-02',     'station-commerce2',     2000,        $orbit, 3, template:'Trade']
  [ 35,  Station, 'UEG Commerce-03',     'station-commerce3',     2000,        $orbit, 3, template:'Trade']
  [ 36,  Station, 'UEG Cylinder-01',     'station-cylinder',      2000,        $orbit, 3, template:'Habitat']
  [ 37,  Station, 'UEG Fleetbase-01',    'station-fleetbase',     2000,        $orbit, 3, template:'Factory']
  [ 38,  Station, 'UEG Fleetbase-02',    'station-fleetbase2',    2000,        $orbit, 3, template:'Factory']
  [ 39,  Station, 'UEG Fleetbase-03',    'station-fleetbase3',    2000,        $orbit, 3, template:'Mine']
  [ 40,  Station, 'UEG Powerplant-01',   'station-powerplant',    1000,        $orbit, 3, template:'Powerplant',provides:e:2000 ]
  [ 41,  Station, 'UEG Shipyard-01',     'station-shipyard',      3000,        $orbit, 3, template:'Factory']
  [ 42,  Station, 'UEG Shipyard-02',     'station-shipyard2',     3000,        $orbit, 3, template:'Factory']
