...
rules.stars = [
  ...
  [ 32,  Station.Fortress, 'UEG Battlestation-01','station-battlestation', 1000,        $orbit, 3 ]
  [ 33,  Station, 'UEG Commerce-01',     'station-commerce',      1000,        $orbit, 3 ]
  [ 34,  Station, 'UEG Commerce-02',     'station-commerce2',     2000,        $orbit, 3 ]
  [ 35,  Station, 'UEG Commerce-03',     'station-commerce3',     2000,        $orbit, 3 ]
  [ 36,  Station, 'UEG Cylinder-01',     'station-cylinder',      2000,        $orbit, 3 ]
  [ 37,  Station, 'UEG Fleetbase-01',    'station-fleetbase',     2000,        $orbit, 3 ]
  [ 38,  Station, 'UEG Fleetbase-02',    'station-fleetbase2',    2000,            $orbit, 3 ]
  [ 39,  Station, 'UEG Fleetbase-03',    'station-fleetbase3',    2000,            $orbit, 3 ]
  [ 40,  Station.Powerplant, 'UEG Powerplant-01',   'station-powerplant',    1000, $orbit, 3 ]
  [ 41,  Station.Factory,    'UEG Shipyard-01',     'station-shipyard',      3000, $orbit, 3 ]
  [ 42,  Station.Factory,    'UEG Shipyard-02',     'station-shipyard2',     3000, $orbit, 3 ]
