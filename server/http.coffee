...
NUU.splashPage = (audio=no) ->
  audioTag = ""
  audioTag = """<audio id="theme" controls autoplay><source src="data:audio/ogg;base64,#{fs.readFileSync('mod/nuu/soundtrack/nuutheme_mk3.ogg').toString 'base64'}" type="audio/ogg"</audio>""" if audio
  page = """
<html><head>
