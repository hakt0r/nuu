...
NUU.splashPage = (audio=no) ->
  audioTag = ""
  audioTag = """<audio id="theme" controls autoplay><source src="data:audio/ogg;base64,#{fs.readFileSync('mod/nuu/soundtrack/nuutheme_mk2.ogg').toString 'base64'}" type="audio/ogg"</audio>""" if audio
  page = """
<html><head>
...
<p class="copyrights fixBottom">
  ...
  &copy; 2007-2018 Sebastian Glaser &lt;anx@ulzq.de&gt; | &copy; 2007-2008 flyc0r
</p></div>
#{audioTag}
<div class='debug'></div>
</body></html>"""
